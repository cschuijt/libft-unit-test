 ...
 * The file descriptor functions aren't being tested right now because I'm lazy. I may go back to it and write some test cases there.
 ...
 * Whether you clean up after yourself in `ft_split` when a malloc fails halfway through building the array.
